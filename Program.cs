...
class Program
{
 ...
 public static (string, List<Tuple<int, int>>) getTriangleIngfo(string? sideAInput, string? sideBInput, string? sideCInput)
 {
 ...
 public static List<Tuple<int, int>> GetVertexCoordinates(float sideA, float sideB, float sideC)
 {
 ...
 public static string GetVertexCoordinatesString(List<Tuple<int, int>> vertexCoordinates)
 {
